...
class ComponentConsolidatorTests: AbstractParserTests {
    ...
    func test_process_withMatchingSets_verifyResults() {
        let components = [ASTComponent(name: "A", dependencyProtocolName: "", isRoot: false, sourceURL: URL(fileURLWithPath: "foo/bar"), properties: [Property(name: "p1", type: "P1")], expressionCallTypeNames: ["E1"])]
