...
class LoggedInComponent: Component<EmptyDependency>, LoggedInBuilder {
    ...
    var scoreStore: ScoreStore {
        return mutableScoreStore
    }

    var loggedInViewController: UIViewController {
        return LoggedInViewController(gameBuilder: gameComponent, scoreStore: scoreStore, scoreSheetBuilder: scoreSheetComponent)
    }
